...
class RdoBuilder:
    ...
    def get_raw_ocr_data(self, timestamp, ad_id):
        """Get the raw OCR data (without offsets) for a given timestamp and ad_id
        ...
        Returns:
            list[OcrDataKeyframe]: A list of OcrDataKeyframe objects containing the OCR matches for each keyframe
        """
        ...
        for index, frame_id in enumerate(frame_ids):
            ...
            outputs.append({
                ...
                "ocr_data": frame_ocr_data,
                "y_source": restitcher_frame.get('y_source', {}),
            })
        return outputs
